package everdream.security;

import everdream.security.token.AuthEntryPoint;
import everdream.security.token.TokenFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain (HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                auth.antMatchers("/api/security/**", "/swagger-ui/**").permitAll();
    ...
    public CorsConfigurationSource corsConfigurationSource () {
        ...
        configuration.setAllowedHeaders(List.of("X-Requested-With", "Origin", "Content-Type", "Accept", "Authorization",
                "withCredentials", "access-control-allow-origin", "access-control-allow-headers"));
    ...
    @Bean
    public TokenFilter getTokenFilter () {return new TokenFilter();}
